...
<div id="editar" class="mb-5 d-flex align-items-center justify-content-center">
    <h2 class="mr-5">Editar Produto</h2>
    ...
    <form action="<?= $BASE_URL?>config/process.php" method="POST" class="ml-5">
        ...
        <div class="form-group">
            ...
            <input class="form-control mr-auto ml-auto" type="text" name="nome" id="nome-produto" value="<?= $produto['nome']?>">
        </div>
        ...
        <div class="form-group">
            ...
            <input class="form-control mr-auto ml-auto" type="text" name="img" id="img-produto" value="<?= $produto['img']?>">
        </div>

            <button type="submit" class="btn btn-outline-primary btn-rosa mt-3">Atualizar</button>
    </form>
</div>
